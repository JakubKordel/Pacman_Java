...
public class Pinky extends Ghost {
    ...
    public Pinky(Map map, Vector2f spawnPos, float speed, Vector2f cagePos, Player player){
        ...
        hunt.priority[0][1][0][0] = Direction.LEFT;
        hunt.priority[0][1][1][0] = Direction.UP;
        ...
        hunt.priority[0][3][0][0] = Direction.RIGHT;
        hunt.priority[0][3][1][0] = Direction.UP;
        ...
        hunt.priority[1][0][0][0] = Direction.UP;
        hunt.priority[1][0][1][0] = Direction.RIGHT;
        hunt.priority[1][0][2][0] = Direction.LEFT;
        hunt.priority[1][0][3][0] = Direction.DOWN;

        hunt.priority[1][1][0][0] = Direction.UP;
        hunt.priority[1][1][1][0] = Direction.RIGHT;
        hunt.priority[1][1][2][0] = Direction.LEFT;
        hunt.priority[1][1][3][0] = Direction.DOWN;

        hunt.priority[1][2][0][0] = Direction.RIGHT;
        hunt.priority[1][2][1][0] = Direction.UP;
        hunt.priority[1][2][2][0] = Direction.DOWN;
        hunt.priority[1][2][3][0] = Direction.LEFT;

        hunt.priority[1][3][0][0] = Direction.RIGHT;
        hunt.priority[1][3][1][0] = Direction.UP;
